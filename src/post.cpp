...
namespace River {
    ...
    bool hasLiked(int postID, const string& username) {
        string likeFile = "data/liked_post_" + to_string(postID) + ".txt";
    ...
    void addLikeUser(int postID, const string& username) {
        ofstream file("data/liked_post_" + to_string(postID) + ".txt", ios::app);
        file << username << "\n";
    }
    ...
    Post* createPost(string username) {
        int globalID = 0;
        ifstream globalFile("data/post_data.txt");
        string line;
        bool isFirstLine = true;
        ...
        ofstream feedPost("data/post_data.txt", ios::app);
        if (!feedPost) {
            cout << "Gagal membuka file untuk menulis!\n";
            return newPost;
        }

        ifstream feedFile("data/post_data.txt");
    ...
    void showFeed(const string& currentUsername){
        ...
        ofstream release("data/post_data.txt", ios::trunc);
        if (!release) {
    ...
    void showComments(int PostID){
        string filename = "data/comment_post_" + to_string(PostID) + ".txt";
        ...
        while (true) {
            ...
            if (lowerInput == 'n') {
                ...
                if (comment_inputLower == 't') {
                    ...
                    string filename = "data/comment_post_" + to_string(current->id) + ".txt";
